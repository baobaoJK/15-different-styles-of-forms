$(function () {
    ...
    // 用户名输入框
    const usernameInput = $(".forget-username");

    // 密码输入框
    const passwordInput = $(".forget-password");

    // 手机号输入框
    const phoneInput = $(".forget-phone");

    // 验证码输入框
    const codeInput = $(".forget-code");

    // 验证码按钮
    const codeButton = $(".forget-code-button");
